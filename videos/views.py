...
def delete_video(request,id):    
    ...
    all_videos = Video.objects.filter(parent=None).filter(user=request.user)
    return render(request, 'videos/profile.html', {'page_user': request.user, 'all_videos': all_videos})    
